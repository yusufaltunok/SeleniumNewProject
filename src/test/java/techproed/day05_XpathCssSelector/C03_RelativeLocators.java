...
public class C03_RelativeLocators {
    public static void main(String[] args) {
        ...
        SYNTAX:
        driver.findElement(with(By.tagname).below().above().to_left_of().to_right_of().near()) gibi metotlar ile
        benzer özelliklere sahip webelementleri locatini almadan o webelemente ulasabiliriz
         */
